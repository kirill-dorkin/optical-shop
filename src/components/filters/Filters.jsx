  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Фильтр товаров</h1>
        <AiOutlineClose
      ...
      <section className="py-3">
        <FilterHeading text="Ценовой диапазон" />
        <InputRange />
      </section>
      <section className="py-3">
        <FilterHeading text="Категории" />
